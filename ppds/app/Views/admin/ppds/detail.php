        ...
        <div class="card mb-4">
            <div class="card-body pb-4">
                <div class="row mr-1 mb-0">
                    <div class="col-md-7">
                        <h4 class="mt-3"><i class="ti-user"></i>&nbsp;<?= $ppds->nama_lengkap; ?> </h4>
                    </div>
                    <div class="col-md-5">
                        <?php if (session('role') == 1) { ?>
                            <?php if ($tahap_selesai) { ?>
                                <?php if ($semua_tahap_selesai) { ?>
                                    <div class="form-group row">
                                        <button type="button" disabled class="tipe_btn btn btn-flat btn-outline-dark btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter" id="tahap">
                                            PPDS telah menyelesaikan <br> semua tahap
                                        </button>
                                    </div>
                                <?php } else { ?>
                                    <div class="form-group row">
                                        <button type="button" class="tipe_btn btn btn-flat btn-outline-dark btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter" id="tahap">Tahap Selesai</button>
                                    </div>
                                <?php } ?>
                            <?php } else { ?>
                                <?php if ($ppds->id_stase != 25) { ?>
                                    <div class="form-group row">
                                        <button type="button" class="tipe_btn btn btn-flat btn-outline-dark btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter" id="stase">Stase Selesai</button>
                                    </div>
                                <?php } ?>
                            <?php } ?>
                        <?php } ?>
